...
import {
  Check, Sparkles, Heart, Wand2, Star, Quote,
  ShieldCheck, Clock, ArrowRight, PlayCircle
} from 'lucide-react'

const GPT_LINK =
  'https://chatgpt.com/g/g-68ba379c921c819197665d3d081c6d4f-vows-and-verses'

const Section = ({ children, id, className = '' }) => (
  <section id={id} className={`w-full max-w-6xl mx-auto px-4 sm:px-6 ${className}`}>
    {children}
  </section>
)
    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <header className="relative overflow-hidden">
        ...
        <Section className="py-16 sm:py-24 text-center">
          <img
            src="https://images.unsplash.com/photo-1529634892080-9f4d5a7a1a2b"
            alt="Wedding couple holding hands"
            className="mx-auto rounded-3xl shadow-md mb-8 max-h-96 object-cover"
          />
          <motion.h1
          ...
          >
            Vows & Verses is a custom AI writing assistant that transforms your memories into polished vows,
            toasts, and speeches—personal, elegant, and truly you.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-2xl px-6 py-3 bg-black text-white hover:opacity-90"
            >
          ...
          <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm text-slate-600">
            {['Wedding vows', 'Best man & maid of honor', 'Parent & friend toasts', 'Anniversaries & proposals'].map(
              (text) => (
                <div
                  key={text}
                  className="px-3 py-2 rounded-xl border border-slate-200 bg-white/60 backdrop-blur"
                >
                  {text}
                </div>
              )
      ...
      <Section id="features" className="py-8 sm:py-16">
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-slate-600 max-w-2xl mx-auto">
            Guided prompts, tone controls, and tailored templates to suit your role and relationship.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          <Feature icon={Sparkles} title="Guided storytelling">
            Answer a few thoughtful questions and watch your story become a compelling draft with a strong beginning,
            heartfelt middle, and memorable closing.
          </Feature>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="mt-6 space-y-4">
              <Tick>
                Open{' '}
                <a href={GPT_LINK} target="_blank" rel="noopener noreferrer" className="underline">
                  Vows & Verses
                </a>{' '}
                and select your occasion (vows, toast, speech).
              </Tick>
      ...
      <Section className="py-12">
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-slate-600 max-w-2xl mx-auto">
            A glimpse of the emotions and memories we help you put into words.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          <img
          ...
          />
          <img
            src="https://images.unsplash.com/photo-1522673607200-164d1b6ce5bc"
            alt="Wedding speech"
            className="rounded-2xl shadow-md object-cover h-64 w-full"
          />
        </div>
      ...
      <Section id="pricing" className="py-8 sm:py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 items-stretch">
          <div className="rounded-2xl border-2 border-transparent hover:border-slate-200 transition">
            ...
            <div className="p-6 space-y-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full inline-flex justify-center rounded-xl px-4 py-2 bg-black text-white hover:opacity-90"
              >
                Start free
              </a>
            </div>
          ...
          <div className="rounded-2xl border-2 border-indigo-200 shadow-sm">
            ...
            <div className="p-6 space-y-4">
              <div className="text-3xl font-bold">
                $9<span className="text-base font-semibold">/occasion</span>
              </div>
              <div className="space-y-2">
          ...
          <div className="rounded-2xl border-2 border-transparent hover:border-slate-200 transition">
            ...
            <div className="p-6 space-y-4">
              <div className="text-3xl font-bold">
                $29<span className="text-base font-semibold">/month</span>
              </div>
              <div className="space-y-2">
        ...
        <div className="w-full max-w-3xl mx-auto space-y-3">
          <details className="border rounded-xl p-4">
            ...
            <p className="mt-2 text-slate-600">
              You can use the free version to generate drafts. For advanced editing tools, Plus is recommended.
            </p>
          </details>
          <details className="border rounded-xl p-4">
            <summary className="font-medium cursor-pointer">Is my information private?</summary>
            <p className="mt-2 text-slate-600">
              Yes—your inputs are used only to generate your draft and aren’t shared publicly. Avoid sensitive data.
            </p>
          </details>
          <details className="border rounded-xl p-4">
            <summary className="font-medium cursor-pointer">Can I change the tone after generating?</summary>
            <p className="mt-2 text-slate-600">
              Absolutely. Use one-click tone refinements (romantic, funny, spiritual, elegant, and more) or ask for specific edits.
            </p>
          </details>
        </div>
      </Section>
      ...
      <Section className="py-16">
        <div className="rounded-3xl border border-slate-200/60 bg-gradient-to-br from-white to-slate-50 p-8 sm:p-12 text-center">
          ...
          <p className="mt-3 text-slate-600">
            In a few minutes you’ll have a heartfelt, polished draft you’re proud to say out loud.
          </p>
